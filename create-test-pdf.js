// Script to create a test PDF with sample prompts for testing
const fs = require('fs');
const path = require('path');

// Sample prompts for testing PDF upload functionality
const testPrompts = `
...
// Write the content to a text file first
fs.writeFileSync('test-prompts.txt', testPrompts);

console.log('✅ Test prompts content created!');
console.log('📄 Content saved to: test-prompts.txt');
console.log('📋 Next step: Convert to PDF using your preferred method');
console.log('');
console.log('💡 You can:');
console.log('1. Copy the content from test-prompts.txt');
console.log('2. Paste into Word/Google Docs');
console.log('3. Export as PDF');
console.log('4. Or use an online text-to-PDF converter');
console.log('');
console.log('🎯 The PDF will contain 7 different prompt examples for testing!');
